...
export default function Itinerary({ plan = mockPlan, onReplace, onRequest, bookingStatuses, allowReplace = true, onReorder, busy = false }) {
  ...
  return (
    <section className="itinerary">
      <header className="itinerary__header">
        ...
        {onReorder && <p className="timeline__hint">Drag the grip to another slot, or use the arrows to change the order. Times and map update after each move.</p>}
      </header>

      <Timeline
        activities={activities}
        onReplace={allowReplace && onReplace ? handleReplace : undefined}
        onRequest={onRequest}
